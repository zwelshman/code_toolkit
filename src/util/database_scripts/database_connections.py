...
class TableConnection(DatabaseConnection):
    ...
    def __init__(self, database: str, server_name: str, username: str = '', table_name: str = '', schema: str = None):
    ...
    def connect_to_table(self):
        ...
        table = Table(f'{self._table_name}', metadata,
                      schema=self._schema, autoload_with=self._engine)
        return table
